...
for P in range(len(I0)):
    ...
    PLASMASTOPP = PLASMASTART+Mic.Micro_i(2e-6,Z,OMEGA_0)
    RAMP_DAMP = 2
...
np.savetxt("THz_power_1e18_1e20_2",THz_power,delimiter=',')
np.savetxt("I0_1e18_1e20_2",I0,delimiter=',')
np.savetxt("Laser_input_1e18_1e20_2",Laser_input,delimiter=',')
np.savetxt("ne_nat__1e18_1e20_2",ne_nat,delimiter=',')
