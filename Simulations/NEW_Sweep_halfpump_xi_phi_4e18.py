...
np.savetxt("THz_power_xi_phi_4e18_5fs",THz_power,delimiter=',')
np.savetxt("THz_power_xi_phi_4e18_5fs_laser",Laser_input,delimiter=',')
np.savetxt("THz_power_xi_phi_4e18_5fs_ion",ne_nat,delimiter=',')
np.savetxt("THz_power_xi_phi_4e18_5fs_xi",xi,delimiter=',')
np.savetxt("THz_power_xi_phi_4e18_5fs_phi",phi,delimiter=',')
