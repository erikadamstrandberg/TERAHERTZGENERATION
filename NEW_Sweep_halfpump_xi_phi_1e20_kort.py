...
np.savetxt("THz_power_xi_phi_1e20_kort",THz_power,delimiter=',')
np.savetxt("THz_power_xi_phi_1e20_laser_kort",Laser_input,delimiter=',')
np.savetxt("THz_power_xi_phi_1e20_ion_kort",ne_nat,delimiter=',')
np.savetxt("THz_power_xi_phi_1e20_xi_kort",xi,delimiter=',')
np.savetxt("THz_power_xi_phi_1e20_phi_kort",phi,delimiter=',')
