...
np.savetxt("Thesis/THz_power_xi_phi_2e18",THz_power_xi_phi,delimiter=",") 
np.savetxt("Thesis/THz_power_xi_phi_2e18_xi",xi,delimiter=",")
np.savetxt("Thesis/THz_power_xi_phi_2e18_phi",phi,delimiter=",")
np.savetxt("Thesis/Laser_input_xi_phi_2e18",Laser_input_xi_phi,delimiter=",")