...
np.savetxt("THz_power_xi_phi_2e18",THz_power,delimiter=',')
np.savetxt("THz_power_xi_phi_2e18_laser",Laser_input,delimiter=',')
np.savetxt("THz_power_xi_phi_2e18_ion",ne_nat,delimiter=',')
np.savetxt("THz_power_xi_phi_2e18_xi",xi,delimiter=',')
np.savetxt("THz_power_xi_phi_2e18_phi",phi,delimiter=',')
