...
np.savetxt("THz_power_xi_phi_1e20",THz_power,delimiter=',')
np.savetxt("THz_power_xi_phi_1e20_laser",Laser_input,delimiter=',')
np.savetxt("THz_power_xi_phi_1e20_ion",ne_nat,delimiter=',')
np.savetxt("THz_power_xi_phi_1e20_xi",xi,delimiter=',')
np.savetxt("THz_power_xi_phi_1e20_phi",phi,delimiter=',')
