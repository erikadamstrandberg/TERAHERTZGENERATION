...
np.savetxt("Thesis/THz_power_xi_phi_1e19",THz_power_xi_phi,delimiter=",") 
np.savetxt("Thesis/THz_power_xi_phi_1e19_xi",xi,delimiter=",")
np.savetxt("Thesis/THz_power_xi_phi_1e19_phi",phi,delimiter=",")
np.savetxt("Thesis/Laser_input_xi_phi_1e19",Laser_input_xi_phi,delimiter=",")