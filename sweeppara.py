...
np.savetxt("THz_power_xi_phi_4e18_temp",THz_power_xi_phi,delimiter=",") 
np.savetxt("THz_power_xi_phi_4e18_xi_temp",xi,delimiter=",")
np.savetxt("THz_power_xi_phi_4e18_phi_temp",phi,delimiter=",")
