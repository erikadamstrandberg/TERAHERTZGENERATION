...
np.savetxt("THz_power_xi_phi_4e18",THz_power,delimiter=',')
np.savetxt("THz_power_xi_phi_4e18_laser",Laser_input,delimiter=',')
np.savetxt("THz_power_xi_phi_4e18_ion",ne_nat,delimiter=',')
