...
np.savetxt("THz_power_xi_phi_3e18",THz_power,delimiter=',')
np.savetxt("THz_power_xi_phi_3e18_laser",Laser_input,delimiter=',')
np.savetxt("THz_power_xi_phi_3e18_ion",ne_nat,delimiter=',')
np.savetxt("THz_power_xi_phi_3e18_xi",xi,delimiter=',')
np.savetxt("THz_power_xi_phi_3e18_phi",phi,delimiter=',')
